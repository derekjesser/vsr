...
function twentyseventeen_setup() {
	...
	register_nav_menus( 
		array(
			...
			'footerbottom_nav' => 'Footer Bottom Links', // bottom nav in footer
        )
	);
...
function custom_header_styles() {
  //if ( is_singular( 'ambassadors' ) || is_post_type_archive( 'ambassadors' ) || is_page_template('tpl-ambassadors.php') ) {
...
add_action( 'wp_enqueue_scripts', 'custom_header_styles', 1 );